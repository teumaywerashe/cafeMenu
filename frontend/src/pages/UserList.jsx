...
// Soft gradient palettes cycled per card
const PALETTES = [
    ...
    >
      ...
      <div className="flex-1 p-4 flex flex-col gap-2">
        <div className="flex items-start justify-between gap-2">
          <h3
            className="font-extrabold text-lg capitalize leading-tight"
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white pt-24 pb-16 px-4">
        ...
        <div className="relative max-w-3xl mx-auto text-center space-y-4">
          ...
          <div className="flex justify-center gap-8 pt-4">
            {[
              { label: "Cafes", value: users.filter((u) => u.role === "admin").length },
