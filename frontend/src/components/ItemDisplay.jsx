...
function ItemDisplay({ item }) {
  ...
  return (
    <div
      className="fles flex-col relative sm:grid grid-cols-[100px_8fr_10fr_10fr_50px] gap-2.5 p-2.5 border border-amber-400 m-2 rounded-2xl shadow-[0_1px_10px_grey] "
      // key={i}
    >
      <img
