  ...
  return (
    <aside className="hidden md:flex flex-col w-64 h-screen sticky top-0 bg-white border-r border-gray-200 shrink-0 font-sans">
      <div className="flex items-center gap-3 h-20 px-8 border-b border-gray-100">
        ...
        <div>
          <h1 className="font-bold text-lg text-gray-800 tracking-tight">Cafe<span className="text-orange-500">Super Admin</span></h1>
      ...
      <nav className="flex-1 flex flex-col gap-1 mt-6">
        <NavLink to="/superadmin/dashboard" className={getLinkClasses}>
          <FaTachometerAlt size={18} /><span>User Dashboard</span>
        </NavLink>
        <NavLink to="/superadmin/management" className={getLinkClasses}>
          <FaUtensils size={18} /><span>User Management</span>
        </NavLink>
        <NavLink to="/superadmin/requests" className={getLinkClasses}>
          <FaClipboardList size={18} /><span>Account Requests</span>
        </NavLink>
