...
function UpdateItem() {
  ...
  const [previewUrl, setPreviewUrl] = useState<string>(originalItem.image);
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-2/3 space-y-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea name="description" id="description" value={data.description} onChange={handleInputChange} rows={4}
                  className="px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all resize-none text-sm text-gray-600"></textarea>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
            ...
            <button type="submit" className="px-8 py-2.5 bg-gray-900 text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30">
              Update Item
            </button>
          </div>
        </form>
